...
/** All packs, sorted by date descending (newest first). First in list is labeled "Today" on the menu. Puzzle order is as defined in each pack. */
export const packs: Pack[] = [...rawPacks].sort((a, b) => b.date.localeCompare(a.date));
